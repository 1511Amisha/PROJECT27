...
function setup() {
	...
	var pendulumDiameter=2*40

	engine = Engine.create();
	world = engine.world;

	//Create the Bodies Here.
	pendulum1=new Pendulum(205,550,40,40);
	pendulum2=new Pendulum(305,550,40,40);
	pendulum3=new Pendulum(405,550,40,40);
	pendulum4=new Pendulum(505,550,40,40);
	pendulum5=new Pendulum(605,550,40,40);
